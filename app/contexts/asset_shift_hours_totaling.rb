class AssetShiftHoursTotaling
  ...
  def generate_totals
    ...
    for person in people do
      ...
      if person_hours > 40 or (person.person_areas and (person.person_areas.first.area.project == prepaid and person_hours > 30)) #Just doing the first person area, since we don't have multiple person areas just yet.
