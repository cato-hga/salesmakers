...
vonage_retail = Project.find_or_create_by name: 'Vonage',
                                          client: vonage
...
vrr = AreaType.find_or_create_by name: 'Vonage Region',
                                 project: vonage_retail
vrm = AreaType.find_or_create_by name: 'Vonage Market',
                                 project: vonage_retail
vrt = AreaType.find_or_create_by name: 'Vonage Territory',
                                 project: vonage_retail
