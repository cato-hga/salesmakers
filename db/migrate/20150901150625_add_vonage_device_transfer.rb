class AddVonageDeviceTransfer < ActiveRecord::Migration
  def change
    group = PermissionGroup.find_or_create_by name: 'Vonage'
    permission = Permission.find_or_create_by key: 'vonage_device_transfer',
                                              permission_group: group,
                                              description: 'Transfer Vonage Inventory'
