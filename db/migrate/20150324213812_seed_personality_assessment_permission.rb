class SeedPersonalityAssessmentPermission < ActiveRecord::Migration
  def self.up
    group = PermissionGroup.find_or_create_by name: 'Candidates'
    permission = Permission.find_or_create_by key: 'candidate_record_assessment',
                                              description: 'can record Candidate assessment scores',
