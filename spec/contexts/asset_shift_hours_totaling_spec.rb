...
describe AssetShiftHoursTotaling do
  ...
  describe '.email_managers' do
    ...
    #   @total = AssetShiftHoursTotaling.new(duration)
    #   @email =
    #   expect(@total).to receive(:email_managers).and
    # }

    it 'emails managers for all employees in the array generated by .generate_totals'
    it 'does not email managers twice if they have two people who passed 40 hours'
