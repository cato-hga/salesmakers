FactoryGirl.define do
  ...
  factory :administrator_person, class: Person do
    ...
    after(:create) do |person|
      ...
      permissions << create(:main_permission, key: 'device_create')
      permissions << create(:main_permission, key: 'device_edit')
      permissions << create(:main_permission, key: 'device_destroy')
      permissions << create(:main_permission, key: 'device_index')
      permissions << create(:main_permission, key: 'device_new')
      permissions << create(:main_permission, key: 'device_update')
      permissions << create(:main_permission, key: 'line_create')
      permissions << create(:main_permission, key: 'line_edit')
      permissions << create(:main_permission, key: 'line_destroy')
      permissions << create(:main_permission, key: 'line_index')
      permissions << create(:main_permission, key: 'line_new')
      permissions << create(:main_permission, key: 'line_update')
