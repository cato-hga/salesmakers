...
RSpec.describe VonageShippedDevicesController, regressor: true do
  # === Routes (REST) ===
  it { should route(:post, '/vonage_shipped_devices').to('vonage_shipped_devices#create', {}) } 
  it { should route(:get, '/vonage_shipped_devices/new').to('vonage_shipped_devices#new', {}) }
  # === Callbacks (Before) ===
