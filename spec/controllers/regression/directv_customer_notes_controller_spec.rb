...
RSpec.describe DirecTVCustomerNotesController, regressor: true do
  # === Routes (REST) ===
  it { should route(:post, '/directv_customers/1/directv_customer_notes').to('directv_customer_notes#create', {:directv_customer_id=>"1"}) } 
  # === Callbacks (Before) ===
