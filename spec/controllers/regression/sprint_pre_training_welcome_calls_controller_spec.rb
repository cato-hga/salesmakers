...
RSpec.describe SprintPreTrainingWelcomeCallsController, regressor: true do
  # === Routes (REST) ===
  it { should route(:get, '/candidates/1/sprint_pre_training_welcome_calls/new').to('sprint_pre_training_welcome_calls#new', {:candidate_id=>"1"}) }
  it { should route(:post, '/candidates/1/sprint_pre_training_welcome_calls').to('sprint_pre_training_welcome_calls#create', {:candidate_id=>"1"}) } 
  # === Callbacks (Before) ===
