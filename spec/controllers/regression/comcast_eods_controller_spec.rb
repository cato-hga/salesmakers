...
RSpec.describe ComcastEodsController, regressor: true do
  # === Routes (REST) ===
  it { should route(:post, '/comcast_eods').to('comcast_eods#create', {}) } 
  it { should route(:get, '/comcast_eods/new').to('comcast_eods#new', {}) }
  # === Callbacks (Before) ===
