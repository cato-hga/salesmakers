...
RSpec.describe ProjectsController, regressor: true do
  # === Routes (REST) ===
  it { should route(:get, '/clients/1/projects/1').to('projects#show', {:client_id=>"1", :id=>"1"}) }
  it { should route(:get, '/clients/1/projects/1/sales').to('projects#sales', {:client_id=>"1", :id=>"1"}) }
  # === Callbacks (Before) ===
