...
RSpec.describe DepartmentsController, regressor: true do
  # === Routes (REST) ===
  it { should route(:get, '/departments').to('departments#index', {}) }
  it { should route(:get, '/departments/1').to('departments#show', {:id=>"1"}) }
  # === Callbacks (Before) ===
