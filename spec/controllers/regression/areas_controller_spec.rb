...
RSpec.describe AreasController, regressor: true do
  # === Routes (REST) ===
  it { should route(:get, '/clients/1/projects/1/areas').to('areas#index', {:client_id=>"1", :project_id=>"1"}) }
  it { should route(:get, '/clients/1/projects/1/areas/1').to('areas#show', {:client_id=>"1", :project_id=>"1", :id=>"1"}) }
  # === Callbacks (Before) ===
