...
RSpec.describe DirecTVEodsController, regressor: true do
  # === Routes (REST) ===
  it { should route(:post, '/directv_eods').to('directv_eods#create', {}) } 
  it { should route(:get, '/directv_eods/new').to('directv_eods#new', {}) }
  # === Callbacks (Before) ===
