...
RSpec.describe RootRedirectsController, regressor: true do
  # === Routes (REST) ===
  it { should route(:get, '/').to('root_redirects#incoming_redirect', {}) }
  it { should route(:get, '/1').to('root_redirects#no_route', {:unmatched_route=>"1"}) }
  # === Callbacks (Before) ===
