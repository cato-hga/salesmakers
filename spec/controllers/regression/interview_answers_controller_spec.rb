...
RSpec.describe InterviewAnswersController, regressor: true do
  # === Routes (REST) ===
  it { should route(:get, '/candidates/1/interview_answers/new').to('interview_answers#new', {:candidate_id=>"1"}) }
  it { should route(:post, '/candidates/1/interview_answers').to('interview_answers#create', {:candidate_id=>"1"}) } 
  # === Callbacks (Before) ===
