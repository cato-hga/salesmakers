...
RSpec.describe ConnectUserMapping, regressor: true do
  ...
  # === Database (Columns) ===
  it { is_expected.to have_db_column :rc_umapping_id }
  ...
  it { is_expected.to have_db_column :data_source }
  it { is_expected.to have_db_column :mapping }
