...
RSpec.describe ComcastCustomer, regressor: true do

  # === Relations ===
  it { is_expected.to belong_to :person }
  it { is_expected.to belong_to :location }
  it { is_expected.to belong_to :comcast_lead_dismissal_reason }
  it { is_expected.to have_one :comcast_lead }
  ...
  it { is_expected.to have_db_column :comcast_lead_dismissal_reason_id }
